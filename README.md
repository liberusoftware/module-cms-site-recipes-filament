...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-site-recipes-filament?sort=semver)](https://github.com/liberusoftware/module-cms-site-recipes-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-site-recipes-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-site-recipes-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-site-recipes-filament
```
...
<a href="https://github.com/liberusoftware/module-cms-site-recipes-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-site-recipes-filament" alt="Contributors to liberusoftware/module-cms-site-recipes-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-site-recipes-filament/graphs/contributors).
